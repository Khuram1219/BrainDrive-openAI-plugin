...
class BrainDriveOpenAILifecycleManager(BaseLifecycleManager):
    ...
    def __init__(self, plugins_base_dir: str = None):
        self.plugin_data = {
            ...
            "source_type": "github",
            "source_url": "https://github.com/Khuram1219/BrainDriveOpenAI",
            "update_check_url": "https://api.github.com/repos/Khuram1219/BrainDriveOpenAI/releases/latest",
    ...
    async def update_plugin(self, user_id: str, db: AsyncSession, new_version_manager: 'BrainDriveOpenAILifecycleManager') -> Dict[str, Any]:
...
if __name__ == "__main__":
    ...
    async def main():
        ...
        manager = BrainDriveOpenAILifecycleManager()
